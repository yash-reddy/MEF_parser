...
if __name__ == '__main__':
    ...
    parser.add_option("--test1", dest="conll_test1", help="Annotated CONLL test file", metavar="FILE", default="data/catib/catib.test.v2.11062020.proj.conllu")
    parser.add_option("--test2", dest="conll_test2", help="Annotated CONLL test file", metavar="FILE", default="data/ud/ud.test.v2.11062020.proj.conllu")
